 ...
 * @file
 * 
 * @brief The source code for an function that does any dynamic memory 
 ...
 *
 * @par Description:
 * Frees memory from a dynamically allocated 2D integer array
 *
 * @param[in] ptr - pointer to the 2D array
 * @param[in] rows - number rows in the image
 *
